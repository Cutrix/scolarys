                                ...
                                <div class="col-xs-12 col-sm-3 center">
                                    <div>
												<span class="profile-picture">
													<img id="avatar" class="editable img-responsive" alt="Alex's Avatar" src="<?= img_url('images/avatars/profile-pic.jpg') ?>" />
												</span>
                                        ...
                                        <div class="width-80 label label-info label-xlg arrowed-in arrowed-in-right">
                                            <div class="inline position-relative">
                                                <a href="#" class="user-title-label dropdown-toggle" data-toggle="dropdown">
                                                    ...
                                                    &nbsp;
                                                    <span class="white"><?= $this->session->userdata('email') ?></span>
                                                </a>
                                ...
                                <div class="col-xs-12 col-sm-9">
                                    ...
                                    <div class="profile-user-info profile-user-info-striped">
                                        <div class="profile-info-row">
                                            <div class="profile-info-name"> Nom professeur </div>
                                            <!--marqueur-->
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="editable" id="username"><?= $this->session->userdata('statut') ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="editable" id="username"><?= $this->session->userdata('email') ?></span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="profile-info-row">
                                            ...
                                            <div class="profile-info-value">
                                                <span class="editable" id="username"><?= $etablissementProf ?></span>
                                            </div>
                                        </div>
                                            ...
                                            <div class="widget-main padding-8">
                                                <div id="profile-feed-1" class="profile-feed">
                                                    <div class="profile-activity clearfix">
                                                        <div>
                                                            <!--<img class="pull-left" alt="Alex Doe's avatar" src="<?= img_url('images/avatars/avatar5.png') ?>" />-->

                                                            <?php foreach ($question_poster as $question): ?>
                                                    <div class="profile-activity clearfix">
                                                        <div>
                                                            <i class="pull-left thumbicon fa fa-check btn-success no-hover"></i>

                                                                <?= $question->qestionText ?>
                                                            <div class="time">
                                                                <i class="ace-icon fa fa-clock-o bigger-110"></i>
                                                                <?=  $question->dateQestion ?>
                                                            </div>
                                                        </div>

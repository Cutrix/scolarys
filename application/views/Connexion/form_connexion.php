                                    ...
                                    <form method="post">
                                        <fieldset>
                                            ...
                                            <div class="clearfix">
                                                ...
                                                <input type="submit" class="width-35 pull-right btn btn-sm btn-primary" value="Se connecter">
                                            </div>
                                ...
                                <div class="widget-main">
                                    ...
                                    <form>
                                        <fieldset>
                                            ...
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="password" class="form-control" placeholder="Repeter le mot de passe" name="pass1"/>
